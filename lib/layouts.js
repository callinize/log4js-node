...
, layoutMakers = {
  ...
  "messagePassThroughWithSource": function() { return messagePassThroughLayoutWithSource },
...
function getStackTrace(){
    ...
    Error.prepareStackTrace = function (dummyObject, v8StackTrace) {
      if(!v8StackTrace) return;
      var caller = v8StackTrace[5];
      if(!caller) return;
      sourceInfo.file = caller.getFileName();
      sourceInfo.line = caller.getLineNumber();
      var func = caller.getFunctionName();
      if(func){
        sourceInfo.func = func;
      }
...
function messagePassThroughLayoutWithSource(loggingEvent){
  return {sourceInfo: getStackTrace(), msg: formatLogData(loggingEvent.data)}
}
...
module.exports = {
  ...
  messagePassThroughLayoutWithSource: messagePassThroughLayoutWithSource,
